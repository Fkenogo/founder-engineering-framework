# FEF Source Methodology Register

**Framework status:** Draft — Not Yet Adoptable  
**Register status:** Draft — Review and Provenance Pending

| Source | Review Status | Provenance Status |
|---|---|---|
| 11thONUS | Pending | Pending |
| Kirimba | Pending | Pending |
| XamPreps | Pending | Pending |
| TrafoLog | Pending | Pending |
| CareNest | Pending | Pending |
| Klockit | Pending | Pending |
| WORKING_WITH_KENOGO materials | Pending | Pending |
