# FEF Work Package Register

**Framework status:** Draft — Not Yet Adoptable  
**Register status:** Draft administrative record — Non-Authoritative

> **Current programme notice:** The [FEF Master Programme](../programme/FEF-MASTER-PROGRAMME.md) is the controlling source for work-package status, sequence, and dependencies. This register remains an administrative index and includes non-work-package items.

| ID | Item Type | Title | Status |
|---|---|---|---|
| FEF-P0-001 | Legacy phase work package | Repository Baseline and Programme Initiation | Complete |
| FEF-WPK-001 | Work package | Prepare FEF-RGS-000 Research Governance Standard | Complete — v0.1 Produced and Technically Reviewed |
...
| FEF-WRP-001 | Pilot operating protocol | Work Package Review Package Protocol | Founder Approved for Pilot Use — Preferred, Not Mandatory, Not a Governance Standard |
| FEF-RGS-000 | Draft standard | Research Governance Standard | Draft v0.2 — Founder Review Required |
| FEF-RDS-001 | Planned standard | Engineering Asset Discovery, Extraction & Framework Recommendation Standard | Planned |
| FEF-P0-002 | Legacy phase programme identifier | Engineering Asset Discovery Programme | Planned — Renamed and Repurposed |
| FEF-P0-003 | Legacy phase decision identifier | Founder Scope, Boundary & Classification Decisions | Planned |
| FEF-P0-004 | Legacy phase work package | Documentation Repository Structure and Draft Authority Model | Planned — Architecture Reconciliation Required |
| FEF-P1-001 | Legacy planning identifier | Framework Constitution | Planned — Sequence Reconciliation Required |
| FEF-P1-002 | Legacy planning identifier | Authority, Source Hierarchy, and Documentation Governance | Planned |
| FEF-P1-003 | Legacy planning identifier | Framework Versioning and Release Governance | Planned |
| FEF-P1-004 | Legacy planning identifier | Framework Adoption, Upgrade, and Deviation Governance | Planned |

`FEF-WPK-001` is the first work package using the permanent-style work-package identifier. Whether all future work packages must use `FEF-WPK-NNN` remains subject to Founder decision; this register does not approve a numbering policy.
