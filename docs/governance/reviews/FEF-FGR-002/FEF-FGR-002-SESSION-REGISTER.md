...
which evidence examination is in progress (3 of 9 RQs examined). S02
...
RQ-016, RQ-017, and RQ-018, has produced only GF-015, GF-016, and GF-017
(all Presented, undispositioned), and remains open. No Open Question is
modified.
