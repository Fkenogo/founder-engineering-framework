# FEF-FGR-002 — Deferred Matter Register
...
| Applicable controls | FEF-FGRC-001 deferred-matter and Open Question controls |
...
| Matter ID | Version | Title | Source | Rationale | Dependencies | Review Trigger | Owner | Lifecycle State | Related OQs | Validation |
|---|---:|---|---|---|---|---|---|---|---|---|
...
Prior programme-level deferrals are not silently imported. A matter enters this register only through a controlled review disposition.
