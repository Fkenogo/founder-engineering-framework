...
**Review state:** D1, ORC-001, and D2 Closed — D3 **Active, Not Closed**: Mobilised; Candidates Prepared, Validated, and Founder-Reviewed; DG-2 Admission Complete; Evidence Mobilised and Qualified; DG-3 Evidence Pack Frozen (EP-003 v1.0, Pass with Conditions); Not Examined; Not Dispositioned
...
| D3 canonical RQs / Evidence Records / packs / sessions / GFs / FDs | 9 / 39 / 1 / 0 / 0 / 0 |
...
| Next gate | Prepare and perform D3 session-entry validation for DG-4, through a separately governed gate; this record does not open that session |
